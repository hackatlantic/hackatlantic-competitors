...
- Same-repository Terraform plans require approval from either infrastructure owner through the separate `terraform-plan` environment. Either owner may approve a plan they initiated; the environment cannot access deployment credentials.
